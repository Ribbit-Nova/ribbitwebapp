...
export default async function BlogDetail({ params }) {
    ...
    useClickOutside(triggerRef, popoverRef, showComment, setShowComment);
    useClickOutside(triggerRef, popoverRef, showReadinglist, setShowReadinglist);
    useClickOutside(triggerRef, popoverRef, showSharebtn, setShowSharebtn);
    ...
    const { title, publishDate, content, coverImage } = post.fields;
                                            ...
                                            <>
                                                {["bottom"].map((placement) => (
                                                    <OverlayTrigger
                                                        ...
                                                        placement={placement}
                                                        show={showComment}
                                                        onToggle={(nextShow) => setShowComment(nextShow)}
                                                        overlay={
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="cmt_post">
                                                                            <p className="pera_sms">
                                                                                ...
                                                                                <span className="user_cm_nmw">
                                                                                    RibbitUser001
                                                                                    <span className="user_cm_sub">
                                                                                        Apr 01
                                                                                    </span>
                                                                                </span>
                                                                            </p>
                                                                            <p className="cmt_pera">
                                            ...
                                            <>
                                                {["bottom"].map((placement) => (
                                                    <OverlayTrigger
                                                        ...
                                                        placement={placement}
                                                        show={showSharebtn}
                                                        onToggle={(nextShow) => setShowSharebtn(nextShow)}
                                                        overlay={
                                                            <Popover id={`popover-positioned-${placement}`}>
                                                                <div ref={popoverRef}>
                                                                    <Popover.Body>
